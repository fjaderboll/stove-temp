...
# This is a modified version of the original RP2040-LCD-1.28.py file from Waveshare:
#  - included method 'write_text' (with variable font size) from the Touch variant
#  - set_bl_pwm called by default
#  - added class Battery
...
class LCD_1inch28(framebuf.FrameBuffer):
    def __init__(self, bl_pwm=65535):
        self.width = 240
        self.height = 240
